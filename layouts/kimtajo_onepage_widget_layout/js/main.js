	...
	var windowScroll = function() {
		...
		$(window).scroll(function(event){
			...
			if ( scrlTop > 500 && scrlTop <= 2000 ) {
				...
				if(transparent_logo_image != undefined){
					transparent_logo_image.addClass('hidden');
					transparent_logo_image.removeClass('show');
					logo_image.addClass('show');
					logo_image.removeClass('hidden');
				}
				...
				if(transparent_logo_image != undefined){
					transparent_logo_image.addClass('show');
					transparent_logo_image.removeClass('hidden');
					logo_image.addClass('hidden');
					logo_image.removeClass('show');
				}
			} 
